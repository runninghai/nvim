...
_G.packer_plugins = {
  ...
  ["calendar-vim"] = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/calendar-vim",
  ...
  ["guihua.lua"] = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/guihua.lua",
  ...
  ["nvim-dap-go"] = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/nvim-dap-go",
  ...
  ["telekasten.nvim"] = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/telekasten.nvim",
  ...
  ["trouble.nvim"] = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/trouble.nvim",
  ...
  ["vim-wakatime"] = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/vim-wakatime",
